...
const ProjectCard = ({title,description,image,link}) => {
  return (
    ...
    transition ease-in-out delay-150 bg-blue-500 cursor-pointer hover:shadow-sky-700 hover:-translate-y-1 hover:scale-110  duration-300 m-5 p-4  font-sans flex  flex-col justify-center items-center bg-gradient-to-r from-gray-600 to-gray-800'>
